...
def create_prob_config(phase_id: str, prob_id: str) -> ProblemConfig:
    ...
    prob_config.train_x_path = prob_config.train_data_path / "X_train.parquet"
    prob_config.train_y_path = prob_config.train_data_path / "y_train.parquet"
    prob_config.test_x_path = prob_config.train_data_path / "X_test.parquet"
    prob_config.test_y_path = prob_config.train_data_path / "y_test.parquet"
